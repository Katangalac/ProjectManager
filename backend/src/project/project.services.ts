import { CreateProjectData, SearchProjectsFilter, Project, UpdateProjectData } from "./Project";
...
import { buildProjectWhereInput, buildUserWhereInput, buildTaskWhereInput, buildTeamWhereInput} from "../utils/utils";
