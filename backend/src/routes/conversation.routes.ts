...
router.post(
  ...
  conversationController.addParticipantToConversationController,
);
...
router.get(
  "/:id/participants",
  conversationController.getConversationsParticipantsController,
);
...
router.get(
  "/:id/messages",
  conversationController.getConversationMessagesController,
);
